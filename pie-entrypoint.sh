...
php_envset () {
  echoerr "PIE_PHP_VERSION: ${PIE_PHP_VERSION:=8.4}"
  ...
  echoerr "PHP_LOGGING: ${PHP_LOGGING:=link}"
  ...
  echoerr "PHP_OPCACHE_JIT: ${PHP_OPCACHE_JIT:=off}"
  echoerr "PHP_OPCACHE_JIT_BUFFER_SIZE: ${PHP_OPCACHE_JIT_BUFFER_SIZE:=100M}"
  echoerr "PHP_REALPATH_CACHE_SIZE: ${PHP_REALPATH_CACHE_SIZE:=16k}"
  echoerr "PHP_REALPATH_CACHE_TTL: ${PHP_REALPATH_CACHE_TTL:=120}"
  echoerr "PHP_APC_SHM_SEGMENTS: ${PHP_APC_SHM_SEGMENTS:=4}"
  (( PHP_APC_SHM_SEGMENTS > 0 )) || PHP_APC_SHM_SEGMENTS=1

  echoerr "PHP_FCGI_MAX_REQUESTS: ${PHP_FCGI_MAX_REQUESTS:=0}"
  echoerr "PHP_FCGI_MAX_CHILDREN (provided): ${PHP_FCGI_MAX_CHILDREN:=0}"

  export PIE_PHP_VERSION PIE_PHPPOOLS_INCLUDE_DIRS PIE_PHPPOOLS_STATUSURLS_FILE PIE_PHPPOOLS_LOG_DIR PIE_POOL_API_KEY
  ...
  export PHP_OPCACHE_MEMORY_CONSUMPTION PHP_OPCACHE_REVALIDATE_FREQ PHP_OPCACHE_INTERNED_STRINGS_BUFFER PHP_OPCACHE_MAX_ACCELERATED_FILES PHP_OPCACHE_JIT PHP_OPCACHE_JIT_BUFFER_SIZE PHP_REALPATH_CACHE_SIZE PHP_REALPATH_CACHE_TTL PHP_APC_SHM_SEGMENTS
